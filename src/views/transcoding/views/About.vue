...
<template>
  ...
  <!--  </div>--><h1 @click="$router.go(0)">关于本网页</h1>
  <div class="window">
    <p>作者：方块郭   <span style="width: 2rem;display: inline-block"></span> 邮箱：guo2018 # 88.com （请将#替换成@）</p>
    <p>本网页为探索前后端互相加解密发送信息的额外产物，换言之，算是学习成果的展示。 关于Base64编码、RSA加解密等已有大量的现成网页小工具，本网页的功能并不齐全——其意义并不在于重复造轮子，而在于记录自己的学习进步。</p>
    <p>如有兴趣可参考作者其他作品，例如<a href="https://guohub8080.github.io/guo_musickit/#/music/readme">乐理计算器（GitHub）</a> /  <a href="https://guohub8080.gitee.io/guo_musickit/#/music/readme">乐理计算器（Gitee）</a>。</p>
    <p>有一句话叫做 “talk is cheap, show me the code.”我将两段代码贴在下方，供交流学习使用。</p>
